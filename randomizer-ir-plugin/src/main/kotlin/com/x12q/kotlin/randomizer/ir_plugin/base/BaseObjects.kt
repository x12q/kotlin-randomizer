...
internal object BaseObjects {
    ...
    val packageName = "com.x12q.kotlin.randomizer"
    ...
    val indiRandomFunctionPackage = FqName("com.x12q.kotlin.randomizer.lib.util.developerErrorMsg")
    ...
    object Fir {
        ...
        val randomConfigClassId = RandomConfig_ClassId
    }
    ...
    object IndependentRandomFunction{
        val randomFunctionPackage = FqName("com.x12q.kotlin.randomizer.lib")
        val randomFunctionName = Name.identifier("random")
