...
class TestRandomListAssignable_Iterable_d {
            ...
            """
                ...
                fun runTest():TestOutput {
                    return withTestOutput {
                        ...
                        putData(random<QxC<Iterable<Iterable<Iterable<Double>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<Iterable<Qx2<Float>>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<Iterable<Qx2<Qx4<String>>>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<Iterable<TwoGeneric<Int, String>>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<Iterable<TwoGeneric<Qx2<Int>, String>>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<Iterable<TwoGeneric<Qx2<Int>, Qx4<String>>>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<Iterable<ThreeGeneric<Int, String, Double>>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<Iterable<ThreeGeneric<Int, Qx2<String>, Double>>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<Iterable<ThreeGeneric<Qx6<Int>, Qx4<String>, Qx2<Double>>>>>>>(randomConfig=TestRandomConfig()))
    ...
    fun `list in type param - 2 nested`() {
        testGeneratedCodeUsingStandardPlugin(
            """
                ...
                fun runTest():TestOutput {
                    return withTestOutput {
                        putData(random<QxC<Iterable<Iterable<Double>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<Qx2<Float>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<Qx2<Qx4<String>>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<TwoGeneric<Int,String>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<TwoGeneric<Qx2<Int>,String>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<TwoGeneric<Qx2<Int>,Qx4<String>>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<ThreeGeneric<Int,String,Double>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<ThreeGeneric<Int,Qx2<String>,Double>>>>>(randomConfig=TestRandomConfig()))
                        putData(random<QxC<Iterable<Iterable<ThreeGeneric<Qx6<Int>,Qx4<String>,Qx2<Double>>>>>>(randomConfig=TestRandomConfig()))
    ...
    fun `list in type param with custom randomizer`() {
        testGeneratedCodeUsingStandardPlugin(
            """
                ...
                fun runTest():TestOutput {
                    return withTestOutput {
                        putData(random<QxC<Iterable<Iterable<Double>>>>(
                            randomConfig=TestRandomConfig(),
                            randomizers = {
                                constant<Iterable<Iterable<Double>>>{listOf((listOf(123.0)))}
                            }
                        ))
                        putData(random<QxC<Iterable<Qx2<Float>>>>(
                            randomConfig=TestRandomConfig(),
                            randomizers = {
